...
public class ProtractorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
         ...
         */
        mAngle = (mAngle > MAX) ? MAX : ((mAngle < -45) ? -45 : mAngle);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mArcRect, -45, MAX, false, mArcPaint);
        canvas.drawArc(mArcRect, -45, mAngle, false, mArcProgressPaint);
...
//        }
    ...
    private void updateAngle(int angle, boolean fromUser) {
        mAngle = (angle > MAX) ? MAX : (angle < -45) ? -45 : angle;
